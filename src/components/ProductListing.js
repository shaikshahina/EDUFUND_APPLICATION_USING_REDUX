...
import "./Home.css";
import { Button,AppBar,Toolbar,Typography,IconButton,makeStyles,TextField,Grid,Paper } from '@material-ui/core'
...
function ProductListing(props) {
    ...
    const limitMutualFundsData = mutualFundsData.slice(0, 10)
